...
#ifndef QUEST_BY_OWNER_H
#define QUEST_BY_OWNER_H
...
namespace Sidequest::Server {
    ...
    class QuestByOwnerCommand: public CommandHandler {
    public:
        QuestByOwnerCommand(Database* database);
